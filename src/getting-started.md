...
::: tip
在你完成自定义后，如果你想要使用 WebGAL 编辑器来方便地实时预览和进行资源管理，可以将构建产物作为定制引擎导入 WebGAL Terre，具体请参考 [如何使用定制引擎](derivative)。如果你正在开发 WebGAL Terre 源码，也可以替换 `packages/terre2/assets/templates/WebGAL_Template` 来更新内置引擎模板。
:::
