import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as n,d}from"./app-107bd1a0.js";const i={},s=d(`<h1 id="变量" tabindex="-1"><a class="header-anchor" href="#变量" aria-hidden="true">#</a> 变量</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>在你弄清楚如何使用场景跳转和分支跳转之前，请不要轻易使用变量系统，这可能会令你感到迷惑！</p></div><h2 id="使用变量" tabindex="-1"><a class="header-anchor" href="#使用变量" aria-hidden="true">#</a> 使用变量</h2><p>设置变量：</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>setVar:a=1; // 可以设置数字
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code>random([lower=0], [upper=1], [floating])</code> 随机数是一个<strong>内置函数</strong>，它支持多个传参：</p><p><strong>参数</strong>：</p><ol><li>[lower=0] (number): 下限。</li><li>[upper=1] (number): 上限。</li><li>[floating] (boolean): 指定是否返回浮点数。</li></ol><p>不写参数，它会生成一个是一个0-1区间的浮点数</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>setVar:a=random();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>当然，我们也可以指定<strong>范围</strong>。比如，你想要5-10之间的随机数，你可以写成：</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>setVar:a=random(5,10);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>当然你想要它使用范围生成的数值也有小数，那么可指定第三个参数：</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>setVar:a=random(5,10,true); # 将会生成5-10之间的浮点数
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container warning"><p class="hint-container-title">注意</p><p><code>config.txt</code>暂未做特殊符号的转义处理。</p></div>`,60),l=[s];function c(r,t){return a(),n("div",null,l)}const u=e(i,[["render",c],["__file","variable.html.vue"]]);export{u as default};
