...
label:label_2; // label_2という名前のラベルを作成します
......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>このスクリプトでは、<code>分岐2</code>を選択した場合、すべて問題ないように見えます。しかし、<code>分岐1</code>を選択すると、<code>分岐1</code>の実行後に<code>分岐2</code>が実行されることに驚かれるでしょう。これは、プログラムが順番に次の行を実行し続け、分岐の終了後にジャンプする場所を指定していないためです。</p>`,34),s=[l];function c(r,v){return d(),a("div",null,s)}const u=e(i,[["render",c],["__file","scenes.html.vue"]]);export{u as default};
