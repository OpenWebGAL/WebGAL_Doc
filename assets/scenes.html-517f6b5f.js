...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>你只需要将选项的文本与选择选项后要进入的剧本名称一一对应起来，就可以实现分支选择的功能了。</p><h3 id="条件展示和选择" tabindex="-1"><a class="header-anchor" href="#条件展示和选择" aria-hidden="true">#</a> 条件展示和选择</h3><p>你也可以根据变量，有条件地展示选项或允许用户点击选项，语法如下：</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>(showConditionVar&gt;1)[enableConditionVar&gt;2]-&gt;叫住她:Chapter-2.txt|回家:Chapter-3.txt;
