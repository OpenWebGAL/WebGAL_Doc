import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as n,e as i}from"./app-b86340f9.js";const d={},c=i(`<h1 id="変数" tabindex="-1"><a class="header-anchor" href="#変数" aria-hidden="true">#</a> 変数</h1><div class="hint-container warning"><p class="hint-container-title">注意</p><p>ラベルの作成と選択肢ジャンプを理解する前に、混乱を招く可能性があるため、変数を軽々しく使用しないでください。</p></div><h2 id="変数の使用" tabindex="-1"><a class="header-anchor" href="#変数の使用" aria-hidden="true">#</a> 変数の使用</h2><p>変数を設定します。</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>setVar:a=1; // 数値の設定が可能
