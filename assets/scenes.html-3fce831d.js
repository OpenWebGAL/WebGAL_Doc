...
label:label_2; // label_2 というラベルを作成する
......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>In this scenes, if you select <code>Branch 2</code>, everything seems to be fine. But if you choose <code>Branch 1</code>, you&#39;ll be surprised to find that after <code>Branch 1</code> finishes executing, <code>Branch 2</code> continues. That&#39;s because the program went on to the next line in order, and you didn&#39;t specify where to jump to at the end of the branch.</p>`,36),l=[s];function c(r,t){return n(),i("div",null,l)}const o=e(d,[["render",c],["__file","scenes.html.vue"]]);export{o as default};
