import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as d,e as a}from"./app-7008dfd5.js";const i={},l=a(`<h1 id="场景与分支" tabindex="-1"><a class="header-anchor" href="#场景与分支" aria-hidden="true">#</a> 场景与分支</h1><p>在 视觉小说 中，跳转章节、场景与分支选择是不可或缺的，因此，WebGAL 也支持场景跳转与分支选择。</p><p>你可以将你的剧本拆分成多个 txt 文档，并使用一个简单的语句来切换当前运行的剧本。</p><div class="hint-container warning"><p class="hint-container-title">警告</p><p>在跳转场景、分支选择或调用场景后，舞台并不会被清除。这也就意味着上一个场景应用的背景音乐、立绘、背景图片等效果会被继承到下一场景。</p><p>如果你使用 WebGAL Terre 可视化编辑器，你应该格外注意，因为编辑器在预览单独的一个场景的时候并不关心上一个场景会带来什么效果。因此，预览效果和实际游戏运行效果可能会有所差别，你应该考虑妥善处理场景跳转前的舞台清理工作。</p></div><h2 id="场景跳转" tabindex="-1"><a class="header-anchor" href="#场景跳转" aria-hidden="true">#</a> 场景跳转</h2><p>假如你现在写了两个章节的剧本，分别是 <code>Chapter-1.txt</code> 与 <code>Chapter-2.txt</code> 。在 <code>Chapter-1.txt</code> 运行结束后，你希望跳转到 <code>Chapter-2.txt</code> 对应的场景，请使用以下语句：</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>changeScene:Chapter-2.txt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>你只需要将选项的文本与选择选项后要进入的剧本名称一一对应起来，就可以实现分支选择的功能了。</p><h2 id="标签跳转" tabindex="-1"><a class="header-anchor" href="#标签跳转" aria-hidden="true">#</a> 标签跳转</h2><p>如果你想要创建一个分支，但是却觉得为此新建一个 TXT 文件太麻烦，你可以尝试使用以下方式在同一文件内实现创建分支和跳转语句。</p><div class="hint-container warning"><p class="hint-container-title">警告</p><p>如果你的分支很长，我不建议你使用这种方式，因为一个 TXT 的行数不适宜太长，否则可能会导致加载慢、响应迟钝等性能问题。</p></div><p>首先，你必须理解如何使用 <code>label</code></p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>......
jumpLabel:label_1; // 跳转到 label_1
......
......
label:label_1; // 创建名为 label_1 的 label 供 jumpLabel 调用
......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>简而言之， <code>jumpLabel</code> 类似于 <code>goto</code> 语句，能够立刻让你的剧本跳到场景（TXT 文件）中的任意一个位置，而这个位置需要你用 <code>label</code> 创建。</p><p>如果把 <code>jumpLabel</code> 比作任意门，那么这个任意门的终点就是 <code>label</code> 所在的位置。</p><p>有了上面的基础，你就可以通过 <code>choose</code> 来实现用分支来跳转到 <code>label</code> 所在的位置了：</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>......
