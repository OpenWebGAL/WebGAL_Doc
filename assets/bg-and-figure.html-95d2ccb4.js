import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,e as a}from"./app-cd77f7e0.js";const d={},s=a(`<h1 id="背景と立ち絵" tabindex="-1"><a class="header-anchor" href="#背景と立ち絵" aria-hidden="true">#</a> 背景と立ち絵</h1><h2 id="背景画像と立ち絵の変更" tabindex="-1"><a class="header-anchor" href="#背景画像と立ち絵の変更" aria-hidden="true">#</a> 背景画像と立ち絵の変更</h2><p>WebGAL が背景画像と立ち絵を読み取れるようにするには、背景画像を <code>background</code> フォルダーに配置し、立ち絵を <code>figure</code> フォルダーに配置する必要があります。</p><p>次に、次の簡単なステートメントを使用して、現在表示されている背景画像と立ち絵を変更します。</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>changeBg:testBG03.jpg; // 背景画像を変更する
