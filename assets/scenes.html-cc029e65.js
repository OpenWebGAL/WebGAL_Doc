...
......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="branch-choose" tabindex="-1"><a class="header-anchor" href="#branch-choose" aria-hidden="true">#</a> Branch choose</h2><p>If branching options exist in your script and you want to go to a different chapter by selecting a different option, use <code>choose</code>.<br> Use <code>choose text:chapter filename</code> to define a choice. Use <code>|</code> to separate selections. An example is shown below:</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>choose:Call out to her:Chapter-2.txt|Go home:Chapter-3.txt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>You just need to correspond the text of the options one-to-one with the script name to enter after selecting the option to achieve the function of branch choices.</p><h2 id="jumps-label" tabindex="-1"><a class="header-anchor" href="#jumps-label" aria-hidden="true">#</a> Jumps label</h2><p>If you want to create a branch but feel it is too troublesome to create a new TXT file, you can try the following to implement creating branches and jumping statements within the same file.</p><div class="hint-container warning"><p class="hint-container-title">Warning</p><p>If your branch is very long, I do not recommend using this method, because the number of lines in a single TXT is not suitable for being too long, otherwise it may cause performance problems such as slow loading and sluggish response.</p></div><p>First, you must understand how to use <code>label</code></p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>......
jumpLabel:label_1; // Jump to label_1
...... 
......
label:label_1; // Create a label named label_1 for jumpLabel to call
......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>In short, <code>jumpLabel</code> is similar to a <code>goto</code> statement, which can immediately make your script jump to any position in the scene (TXT file), and this position needs you to create it with <code>label</code>.</p><p>If <code>jumpLabel</code> is compared to a portal, then the destination of this portal is the position where the <code>label</code> is located.</p><p>With the above basis, you can use <code>choose</code> to jump to the position where <code>label</code> is located through branches.</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>......
...
label:label_2; // create a label named label_2
......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>In this scenes, if you select <code>Branch 2</code>, everything seems to be fine. But if you choose <code>Branch 1</code>, you&#39;ll be surprised to find that after <code>Branch 1</code> finishes executing, <code>Branch 2</code> continues. That&#39;s because the program went on to the next line in order, and you didn&#39;t specify where to jump to at the end of the branch.</p>`,32),l=[t];function c(d,o){return n(),a("div",null,l)}const h=e(s,[["render",c],["__file","scenes.html.vue"]]);export{h as default};
