...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>你只需要将选项的文本与选择选项后要进入的剧本名称一一对应起来，就可以实现分支选择的功能了。</p><h3 id="条件展示和选择" tabindex="-1"><a class="header-anchor" href="#条件展示和选择" aria-hidden="true">#</a> 条件展示和选择</h3><p>你也可以根据变量，有条件地展示选项或允许用户点击选项，语法如下：</p><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>choose:(showConditionVar&gt;1)[enableConditionVar&gt;2]-&gt;叫住她:Chapter-2.txt|回家:Chapter-3.txt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这里，showConditionVar&gt;1 时才会展示第一个选项，enableConditionVar&gt;2 时才会允许用户点击。</p><h2 id="标签跳转" tabindex="-1"><a class="header-anchor" href="#标签跳转" aria-hidden="true">#</a> 标签跳转</h2><p>如果你想要创建一个分支，但是却觉得为此新建一个 TXT 文件太麻烦，你可以尝试使用以下方式在同一文件内实现创建分支和跳转语句。</p><div class="hint-container warning"><p class="hint-container-title">注意</p><p>如果你的分支很长，我不建议你使用这种方式，因为一个 TXT 的行数不适宜太长，否则可能会导致加载慢、响应迟钝等性能问题。</p></div><h3 id="创建标签-label" tabindex="-1"><a class="header-anchor" href="#创建标签-label" aria-hidden="true">#</a> 创建标签（<code>label</code>）</h3><div class="language-ws line-numbers-mode" data-ext="ws"><pre class="language-ws"><code>......
